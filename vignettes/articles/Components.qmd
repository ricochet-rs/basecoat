...
bc_field_group(
  ...
  bc_field(
    htmltools::tags$label(`for` = "email-field", "Email"),
    htmltools::tags$input(id = "email-field", type = "email"),
    htmltools::tags$p("We never share your address.")
  ),
  bc_field_separator(),
  bc_field(
    htmltools::tags$label(`for` = "password-field", "Password"),
    htmltools::tags$input(id = "password-field", type = "password")
  )
)
```
  ...
  bc_dialog(
    ...
    content = htmltools::tags$div(
      ...
      htmltools::tags$input(
        class = "input", type = "text", id = "name", value = "Pedro Duarte"
      )
    ),
